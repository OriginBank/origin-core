...
contract sLGNS is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Longinus", "sLGNS", 9) ERC20Permit() {
    ...
    function initialize( address stakingContract_) external returns ( bool ) {
        ...
        emit TransferGons(address(0x0), stakingContract, TOTAL_GONS );
    ...
    function transfer( address to, uint256 value ) public override returns (bool) {
        ...
        emit TransferGons(msg.sender,to, gonValue);
        return true;
    }
    ...
    function transferFrom( address from, address to, uint256 value ) public override returns ( bool ) {
       ...
       emit Approval( from, msg.sender,  _allowedValue[ from ][ msg.sender ] );
        ...
        emit TransferGons(from,to,gonValue);
